    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        btnGetStarted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position==0||position==1){
                    ...
                    Intent intent = new Intent(ctx, CustomImageActivity.class);
        ...
        switch (position)
        {
            case 0:
                ...
                title.setText(R.string.shoping_place);
                desc.setText(R.string.this_is_random_text_taking_from_lorem_ipsum_tesing_puspose);
            ...
            case 1:
                ...
                btnGetStarted.setText(R.string.next);
                title.setText(R.string.shoping_place);
                desc.setText(R.string.this_is_random_text_taking_from_lorem_ipsum_tesing_puspose); back.setVisibility(View.VISIBLE);
                next.setVisibility(View.VISIBLE);
                break;
            case 2:
